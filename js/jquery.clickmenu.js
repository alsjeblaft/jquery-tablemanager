 ...
 * /web/20140901022254/http://p.sohei.org
 *
 * Changelog:
 * v 0.1.6 - 2007-09-06
...
(function($)
{
	...
	$.fn.clickMenu = function(options)
	{
		...
		{
			//add .contains() to mozilla - /web/20140901022254/http://www.quirksmode.org/blog/archives/2006/01/contains_for_mo.html
			...
			if ( $.browser.msie && (!$.browser.version || parseInt($.browser.version) <= 6) )
			{
				...
				{
					/* thanks to Mark Gibson - /web/20140901022254/http://www.nabble.com/forum/ViewPost.jtp?post=6504414&framed=y */
